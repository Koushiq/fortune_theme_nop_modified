...
namespace Nop.Plugin.NopStation.MegaMenu.Services
{
    public class MegaMenuCoreService : IMegaMenuCoreService
    {
        ...
        public virtual IList<Category> GetCategoriesByIds(int storeId = 0, List<int> selectedIds = null, int pageSize = int.MaxValue, bool showHidden = false)
        {
        ...
        public virtual IList<Manufacturer> GetManufacturersByIds(int storeId = 0, List<int> selectedIds = null, int pageSize = int.MaxValue, bool showHidden = false)
        {

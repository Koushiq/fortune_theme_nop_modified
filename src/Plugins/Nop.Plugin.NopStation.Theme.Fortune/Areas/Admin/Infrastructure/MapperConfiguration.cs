...
namespace Nop.Plugin.NopStation.Theme.Fortune.Areas.Admin.Infrastructure
{
    public class MapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        {
            CreateMap<FortuneSettings, ConfigurationModel>()
            ...
            CreateMap<ConfigurationModel, FortuneSettings>();
        }
    }
}

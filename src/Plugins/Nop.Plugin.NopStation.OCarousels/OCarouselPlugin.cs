...
namespace Nop.Plugin.NopStation.OCarousels
{
    public class OCarouselPlugin : BasePlugin, IWidgetPlugin, IAdminMenuPlugin, INopStationPlugin
    {
        ...
        private void CreateSampleData()
        {
            ...
            _settingService.SaveSetting(carouselSettings);
            ...
            _carouselService.InsertCarousel(carousel1);
            ...
            _carouselService.InsertCarousel(carousel2);
            ...
            _carouselService.InsertCarousel(carousel3);
            ...
            _carouselService.InsertCarousel(carousel4);
        }
        ...
        public void ManageSiteMap(SiteMapNode rootNode)
        {
            if (_permissionService.Authorize(OCarouselPermissionProvider.ManageOCarousels))
            {
                ...
                {
                    Title = _localizationService.GetResource("Admin.NopStation.OCarousels.Menu.OCarousel"),
                    Visible = true,
                ...
                {
                    Title = _localizationService.GetResource("Admin.NopStation.OCarousels.Menu.List"),
                ...
                {
                    Title = _localizationService.GetResource("Admin.NopStation.OCarousels.Menu.Configuration"),
                ...
                var documentation = new SiteMapNode()
                {
                    ...
                    Url = "https://www.nop-station.com/ocarousel-documentation?utm_source=admin-panel",
                    Visible = true,
                    IconClass = "fa-genderless",
        ...
        {
            CreateSampleData();
            this.NopStationPluginInstall(new OCarouselPermissionProvider());
            base.Install();
        }

        public override void Uninstall()
        {
            this.NopStationPluginUninstall(new OCarouselPermissionProvider());
            base.Uninstall();
        }

...
namespace Nop.Plugin.NopStation.AnywhereSlider.Areas.Admin.Infrastructure
{
    public class MapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        {
            CreateMap<AnywhereSliderSettings, ConfigurationModel>()
            ...
            CreateMap<ConfigurationModel, AnywhereSliderSettings>();

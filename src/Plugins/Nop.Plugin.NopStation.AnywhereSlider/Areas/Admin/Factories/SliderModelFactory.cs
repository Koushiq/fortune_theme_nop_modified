...
namespace Nop.Plugin.NopStation.AnywhereSlider.Areas.Admin.Factories
{
    public partial class SliderModelFactory : ISliderModelFactory
    {
        ...
        protected void PrepareActiveOptions(IList<SelectListItem> items, bool withSpecialDefaultItem = true)
        {
            ...
            {
                Text = _localizationService.GetResource("Admin.NopStation.AnywhereSlider.Sliders.List.SearchActive.Active"),
                Value = "1"
            });
            items.Add(new SelectListItem()
            {
                Text = _localizationService.GetResource("Admin.NopStation.AnywhereSlider.Sliders.List.SearchActive.Inactive"),
                Value = "2"
            });
        ...
        public ConfigurationModel PrepareConfigurationModel()
        {
            ...
            var sliderSettings = _settingService.LoadSetting<AnywhereSliderSettings>(storeId);

...
using Nop.Plugin.NopStation.AnywhereSlider.Infrastructure.Cache;
...
namespace Nop.Plugin.NopStation.AnywhereSlider.Factories
{
    public class SliderModelFactory : ISliderModelFactory
    {
        ...
        public IList<SliderModel> PrepareSliderListModel(string widgetZone)
        {
            ...
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(ModelCacheEventConsumer.ANYWHERESLIDER_SLIDER_MODEL_KEY, 
                widgetZoneId,
        ...
        public SliderModel PrepareSliderModel(Slider slider, bool mobileDevice) 
        {
            ...
            var cacheKey = _cacheKeyService.PrepareKeyForDefaultCache(ModelCacheEventConsumer.ANYWHERESLIDER_SLIDER_ITEM_MODEL_KEY,
                slider,
                mobileDevice,
                _workContext.WorkingLanguage,
                _storeContext.CurrentStore);

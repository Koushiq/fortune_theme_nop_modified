    ...
    public class SliderHelper
    {
        ...
        public static List<WidgetZoneModel> GetCustomWidgetZoneNameValues()
        {
            ...
            try
            {
                ...
                var filePath = nopFileProvider.Combine(nopFileProvider.MapPath("/Plugins/NopStation.CustomSlider/"), "widgetZones.json");
        ...
        public static List<AnimationTypeModel> GetSliderAnimationTypes()
        {
            ...
            {
                var nopFileProvider = EngineContext.Current.Resolve<INopFileProvider>();
                var filePath = nopFileProvider.Combine(nopFileProvider.MapPath("/Plugins/NopStation.CustomSlider/"), "animateOptions.json");

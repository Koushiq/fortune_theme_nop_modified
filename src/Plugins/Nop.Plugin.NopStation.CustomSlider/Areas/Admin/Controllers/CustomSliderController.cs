...
namespace Nop.Plugin.NopStation.CustomSlider.Areas.Admin.Controllers
{
    [NopStationLicense]
    public class CustomSliderController : BaseAdminController
    {
        #region Fields
        ...
        private readonly CustomSliderSettings _sliderSettings;
        ...
        public CustomSliderController(IStoreContext storeContext,
        ...
        public IActionResult Configure(ConfigurationModel model)
        {
            ...
            var sliderSettings = _settingService.LoadSetting<CustomSliderSettings>(storeScope);
            ...
            _notificationService.SuccessNotification(_localizationService.GetResource("Admin.NopStation.CustomSlider.Configuration.Updated"));
        ...
        public IActionResult Create(SliderModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _notificationService.SuccessNotification(_localizationService.GetResource("Admin.NopStation.CustomSlider.Sliders.Created"));
        ...
        public virtual IActionResult Edit(SliderModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _notificationService.SuccessNotification(_localizationService.GetResource("Admin.NopStation.CustomSlider.Sliders.Updated"));
        ...
        public IActionResult Delete(SliderModel model)
        {
            ...
            _notificationService.SuccessNotification(_localizationService.GetResource("Admin.NopStation.CustomSlider.Sliders.Deleted"));
